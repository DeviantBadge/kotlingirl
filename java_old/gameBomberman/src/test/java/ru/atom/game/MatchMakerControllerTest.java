...
public class MatchMakerControllerTest {
    ...
    public void onlineTest() throws Exception {
        mockMvc.perform(get("/game/online"))
    ...
    public void registerTest() throws  Exception {
        mockMvc.perform(post("/game/register")
                .content("name=" + gen.generateName() + "&password=123&passCopy=123")
                .contentType(MediaType.APPLICATION_FORM_URLENCODED_VALUE))
                .andExpect(status().isOk());
    }
    ...
    public void loginTest() throws  Exception {
        ...
        mockMvc.perform(post("/game/register")
                ...
                .contentType(MediaType.APPLICATION_FORM_URLENCODED_VALUE));
        //logout
        mockMvc.perform(post("/game/logout")
                .content("name=" + name)
                .contentType(MediaType.APPLICATION_FORM_URLENCODED_VALUE));
        //only then we can perform login
        mockMvc.perform(post("/game/login")
    ...
    public void usersTest() throws Exception {
        mockMvc.perform(get("/game/users"))
                .andExpect(status().isOk());
    }
